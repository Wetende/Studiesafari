...
final class UpdateLessonRequest extends FormRequest
{
    ...
    {
        // Policy check: User can update the lesson
    ...
    {
        // Assuming lesson_type cannot be changed after creation for simplicity.
        // If it can, logic similar to StoreLessonRequest for lesson_type specific rules is needed.
        $lesson = $this->route('lesson'); // Get the lesson model instance from the route
