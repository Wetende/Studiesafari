                    ...
                    <div class="menu js-navList">
                        <ul class="menu__nav text-white -is-active">
                            <li class="menu-item-has-children">
                                <a data-barba href="#" style="cursor: pointer" onclick="window.location.href='/'">Home</a>
                            </li>
                            ...
                            <li class="menu-item-has-children -has-mega-menu">
                                ...
                                <div class="mega xl:d-none">
                                    <div class="mega__menu">
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                <h4 class="text-17 fw-500 mb-20">About Instructors</h4>

                                                <ul class="mega__list">
                                                    <li><a data-barba href="instructors-list-1.html">View
                                                            Instructors</a></li>
                                        ...
                                        <div class="mega-banner bg-purple-1 ml-40">
                                            ...
                                            <a href="#"
                                                class="button -md -green-1 text-dark-1 fw-500 col-12">Start Learning
                                                For Free</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <ul class="subnav d-none xl:d-block">
                                    ...
                                    <li class="menu-item-has-children">
                                        <a href="#">Course List Layouts<div class="icon-chevron-right text-11">
                                            </div></a>
                                    ...
                                    <li class="menu-item-has-children">
                                        <a href="#">About Courses<div class="icon-chevron-right text-11"></div>
                                            </a>
                            ...
                            <li class="menu-item-has-children">
                                <a data-barba href="#" style="cursor: pointer" onclick="window.location.href='/blogs'">Blog</a>
                            </li>
            ...
            <div class="col-auto">
                <div class="header-right d-flex items-center">
                                    ...
                                    <div class="container">
                                        ...
                                        <div class="header-search__content mt-30">
                                            ...
                                            <div class="d-flex y-gap-5 flex-column mt-20">
                                                ...
                                                <a href="courses-single-3.html" class="text-dark-1">Complete Blender
                                                    Creator: Learn 3D Modelling for Beginners</a>
                                                <a href="courses-single-4.html" class="text-dark-1">User Experience
                                                    Design Essentials - Adobe XD UI UX Design</a>
                                                <a href="courses-single-5.html" class="text-dark-1">Graphic Design
                                                    Masterclass - Learn GREAT Design</a>
                                                <a href="courses-single-6.html" class="text-dark-1">Adobe Photoshop CC
                                                    – Essentials Training Course</a>
                                            </div>
                    ...
                    <div class="header-right__buttons d-flex items-center ml-30 md:d-none">
                        <a href="/login" class="button -underline text-white">Log in</a>
