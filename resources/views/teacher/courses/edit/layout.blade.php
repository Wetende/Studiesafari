...
@push('styles')
    {{-- Add page-specific styles if any --}}
@endpush
                        ...
                        <div class="card-header">
                            <ul class="nav nav-tabs-custom rounded card-header-tabs border-bottom-0" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link {{ request()->routeIs('teacher.courses.edit', $course->id) || request()->routeIs('teacher.courses.curriculum', $course->id) ? 'active' : '' }}" 
                                       href="{{ route('teacher.courses.curriculum', $course->id) }}" 
                                       role="tab" aria-selected="{{ request()->routeIs('teacher.courses.edit', $course->id) || request()->routeIs('teacher.courses.curriculum', $course->id) ? 'true' : 'false' }}">
                                        Curriculum
                                    </a>
                                </li>
                                <li class="nav-item" role="presentation">
