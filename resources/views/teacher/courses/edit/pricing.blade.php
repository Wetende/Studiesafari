...
@section('tab-content')
<div id="pricingTab">
    <h4 class="text-dark-1 mb-4">Course Pricing</h4>
                    ...
                    <div class="card-body">
                        <div class="mb-4">
                            <div class="form-check form-check-inline mb-3">
                                ...
                                <label class="form-check-label" for="pricing_free">Free Course</label>
                            </div>
                            <div class="form-check form-check-inline mb-3">
                                <input class="form-check-input" type="radio" name="pricing_type" id="pricing_paid" value="paid" 
                                       {{ ($course->price > 0) ? 'checked' : '' }}>
                                <label class="form-check-label" for="pricing_paid">Paid Course</label>
                            </div>
                        ...
                        <!-- Paid Course Options -->
                        <div id="paidCourseOptions" class="pricing-options mt-4 pb-3 border-bottom" style="{{ ($course->price > 0) ? '' : 'display: none;' }}">
                            <h6 class="mb-3">Paid Course Settings</h6>
                            ...
                            <div class="mb-3">
                                ...
                                <small class="text-muted">Set the price students must pay for one-time access to this course.</small>
                                @error('price')
                            ...
                            <div class="mb-3">
                                ...
                                <small class="text-muted">If checked, students can access this course either by direct purchase or via subscription.</small>
                            </div>
                        </div>

                        <!-- Subscription Options -->
                        <div id="subscriptionOptions" class="pricing-options mt-4" 
                             style="{{ ($course->subscription_required || ($course->price > 0 && $course->subscription_required)) ? '' : 'display: none;' }}">
                            ...
                            <div class="mb-3">
                                ...
                                <small class="text-muted">Minimum subscription tier required to access this course.</small>
                ...
                <div class="card -dark-bg-light-1 mb-4">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <small class="text-muted">If enabled, students can apply coupon codes to this course.</small>
                        </div>
                ...
                <div class="card -dark-bg-light-1 mb-4">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <small class="text-muted">Allow organizations to purchase multiple licenses for this course.</small>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <small class="text-muted">Allow users to purchase this course as a gift for others.</small>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        alsoSubscriptionCheckbox.addEventListener('change', function() {
            if (document.querySelector('input[name="pricing_type"]:checked').value === 'paid') {
