...
<div class="space-y-4">
    <div>
        <label for="quiz_id_{{ $lessonType }}" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Select Quiz</label>
        ...
        @enderror
        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Only quizzes belonging to this course can be linked.</p>
    </div>

    <div>
        <label for="instructions_quiz_link_{{ $lessonType }}" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Instructions (Optional)</label>
